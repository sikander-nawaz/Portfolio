...
const NavBar = () => {
  ...
  return (
    <header className="relative z-10 w-full px-32 py-8 font-medium flex items-center justify-between dark:text-light lg:px-16 md:px-12 sm:px-8">
      ...
      >
        <span
          className={`bg-dark dark:bg-light block transaction-all duration-300 ease-out h-0.5 w-6 rounded-sm  ${
            isOpen ? "rotate-45 translate-y-1" : "-translate-y-0.5"
          }`}
        ></span>
        <span
          className={`bg-dark dark:bg-light block transaction-all duration-300 ease-out h-0.5 w-6 rounded-sm my-0.5  ${
      ...
      {isOpen ? (
        ...
        >
          ...
          <nav className="flex items-center justify-center flex-wrap mt-2">
            ...
            <button
              className={`ml-4 flex items-center justify-center rounded-full lg sm:ml-1 ${
                mode === "light" ? "bg-dark text-light" : "bg-light text-dark"
              } `}
              onClick={() => setMode(mode === "light" ? "dark" : "light")}
            >
